...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Please Enter the Title'}),
            ...
            'sale_price': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Please Enter the sale price'}),
        }